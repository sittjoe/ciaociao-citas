      ...
      <AnimatePresence mode="wait">
        {value ? (
          <motion.div
            ...
            className="flex items-center justify-between p-3 bg-cream-soft border border-ink-line rounded-xl"
          >
            <div className="flex items-center gap-2 min-w-0">
              <FileCheck size={18} strokeWidth={1.5} className="text-champagne shrink-0" />
          ...
          <motion.label
            ...
            className={cn(
              ...
              dragging
                ...
                : 'border-ink-line hover:border-champagne hover:bg-champagne-soft/50',
          ...
          >
            <input
              ...
              className="sr-only"
            />
            <Upload size={24} strokeWidth={1.5} className={cn(
